...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sh', 'lb', 'bs', 'is', 'mr', 'cy', 'jv', 'lv', 'tl', 'sq', 'pms',
            'bpy', 'be-x-old', 'ta', 'bn', 'oc', 'an', 'be', 'io', 'sw', 'nds',
            'scn', 'fy', 'qu', 'af', 'su', 'gu', 'zh-yue', 'ast', 'ur', 'nap',
            'ku', 'bat-smg', 'ml', 'lmo', 'wa', 'cv', 'ksh', 'ga', 'tg', 'hy',
            'roa-tara', 'vec', 'kn', 'gd', 'yi', 'uz', 'yo', 'pam', 'os',
            ...
            'se', 'fur', 'lij', 'si', 'ug', 'mt', 'nov', 'bh', 'mzn', 'csb',
            ...
            'ba', 'or', 'dsb', 'kg', 'lo', 'udm', 'rmy', 'kl', 'cu', 'ab',
            'kaa', 'mwl', 'ce', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'pcd',
