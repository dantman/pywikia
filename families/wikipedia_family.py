...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'hi', 'ht', 'el', 'war', 'te', 'ceb', 'mk', 'la', 'ka', 'az', 'br',
            'sh', 'lb', 'bs', 'is', 'mr', 'jv', 'lv', 'cy', 'tl', 'sq', 'pms',
            'bpy', 'be-x-old', 'ta', 'bn', 'oc', 'an', 'be', 'io', 'sw', 'nds',
            'fy', 'scn', 'qu', 'af', 'su', 'gu', 'zh-yue', 'ast', 'ur', 'lmo',
            'nap', 'ku', 'bat-smg', 'ml', 'wa', 'cv', 'ksh', 'ga', 'tg', 'hy',
            'roa-tara', 'vec', 'kn', 'yo', 'gd', 'yi', 'uz', 'pam', 'os',
            'zh-min-nan', 'mi', 'kk', 'sah', 'als', 'tt', 'nah', 'li', 'glk',
            'roa-rup', 'hsb', 'co', 'arz', 'gan', 'ia', 'bcl', 'mn', 'fiu-vro',
            'pnb', 'nds-nl', 'vls', 'fo', 'tk', 'sa', 'ne', 'am', 'dv', 'nrm',
            'pag', 'bar', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq', 'wuu',
            'se', 'fur', 'si', 'lij', 'ug', 'mt', 'nov', 'bh', 'mzn', 'csb',
            'ilo', 'zh-classical', 'pi', 'km', 'lad', 'mg', 'sc', 'frp', 'ang',
            'kw', 'hif', 'ckb', 'bo', 'pdc', 'haw', 'szl', 'pa', 'ps', 'ie',
            'hak', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn', 'ln', 'nv',
            'krc', 'mhr', 'cbk-zam', 'ky', 'ext', 'jbo', 'arc', 'wo', 'ty',
            'xal', 'eml', 'kab', 'tpi', 'so', 'zea', 'pap', 'srn', 'ay', 'ba',
            'ig', 'or', 'dsb', 'kg', 'udm', 'lo', 'rmy', 'kl', 'cu', 'mwl',
            'ab', 'kaa', 'ce', 'sm', 'av', 'ks', 'tet', 'got', 'pcd', 'sd',
            'mdf', 'na', 'bm', 'pnt', 'iu', 'pih', 'as', 'fj', 'cdo', 'ee',
            'bug', 'chr', 'om', 'zu', 'bi', 'ti', 'za', 'ss', 'ts', 've', 'ha',
            'dz', 'sg', 'ch', 'cr', 'xh', 'ak', 'lbe', 'tn', 'ki', 'ik', 'bxr',
