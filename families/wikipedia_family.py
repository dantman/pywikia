...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ko', 'eo', 'da', 'ar', 'vo', 'id', 'vi', 'sk', 'sr', 'lt',
            'he', 'bg', 'fa', 'sl', 'hr', 'et', 'new', 'ms', 'th', 'simple',
            'gl', 'nn', 'hi', 'eu', 'ht', 'el', 'te', 'ceb', 'mk', 'la',
            'ka', 'br', 'az', 'bs', 'lb', 'sh', 'is', 'mr', 'cy', 'sq',
            'jv', 'lv', 'bpy', 'tl', 'pms', 'be-x-old', 'ta', 'bn', 'oc', 'an',
            'be', 'io', 'war', 'sw', 'nds', 'scn', 'fy', 'qu', 'su', 'af',
            'gu', 'zh-yue', 'ast', 'nap', 'ku', 'ur', 'bat-smg', 'ml', 'wa', 'cv',
            'ksh', 'ga', 'lmo', 'tg', 'roa-tara', 'vec', 'hy', 'kn', 'gd', 'uz',
            'pam', 'yi', 'mi', 'zh-min-nan', 'kk', 'nah', 'als', 'sah', 'glk', 'li',
            'hsb', 'co', 'tt', 'roa-rup', 'yo', 'ia', 'os', 'arz', 'bcl', 'gan',
            'fiu-vro', 'mn', 'nds-nl', 'vls', 'tk', 'fo', 'sa', 'am', 'pnb', 'dv',
            'nrm', 'pag', 'ne', 'rm', 'map-bms', 'bar', 'wuu', 'gv', 'my', 'sco',
            'diq', 'se', 'fur', 'lij', 'si', 'nov', 'mt', 'ug', 'bh', 'mzn',
            'csb', 'ilo', 'zh-classical', 'pi', 'km', 'lad', 'sc', 'mg', 'frp', 'ang',
            'kw', 'pdc', 'haw', 'szl', 'ckb', 'ps', 'hif', 'bo', 'pa', 'ie',
            'hak', 'kv', 'to', 'crh', 'stq', 'myv', 'gn', 'ln', 'mhr', 'nv',
            'ace', 'arc', 'ext', 'jbo', 'ky', 'wo', 'ty', 'tpi', 'eml', 'cbk-zam',
            'so', 'zea', 'kab', 'srn', 'ay', 'pap', 'or', 'ig', 'ba', 'kg',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ab', 'ce', 'sm', 'xal',
            'av', 'ks', 'tet', 'got', 'kl', 'sd', 'mdf', 'mwl', 'na', 'bm',
            'pnt', 'iu', 'pih', 'pcd', 'as', 'cdo', 'chr', 'ee', 'om', 'zu',
            'ti', 'ts', 'za', 'ss', 've', 'bi', 'ha', 'dz', 'cr', 'ch',
            'bxr', 'xh', 'bug', 'tn', 'ki', 'sg', 'ik', 'rw', 'st', 'ny',
            'tw', 'ak', 'fj', 'sn', 'ff', 'lg', 'lbe', 'tum', 'chy', 'rn',
        ]
        ...
        self.namespaces[5] = {
            ...
            'kl': [u'Wikipediaip oqalliffia', u'Wikipedia-diskussion'],
            ...
            'tt': [u'Википедия бәхәсе', u'Wikipedia бәхәсе', u'Wikipedia bäxäse'],
