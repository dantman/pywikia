...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lt', 'bg', 'fa', 'sl', 'hr', 'et', 'new', 'ms', 'simple', 'gl',
            'th', 'nn', 'hi', 'ht', 'eu', 'el', 'te', 'ceb', 'mk', 'ka',
            'la', 'br', 'az', 'bs', 'lb', 'sh', 'is', 'mr', 'cy', 'sq',
            'lv', 'bpy', 'jv', 'tl', 'be-x-old', 'pms', 'bn', 'ta', 'oc', 'an',
            'io', 'be', 'sw', 'nds', 'scn', 'su', 'fy', 'af', 'nap', 'zh-yue',
            'ku', 'ast', 'ur', 'bat-smg', 'gu', 'ml', 'wa', 'qu', 'war', 'cv',
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'kn', 'gd', 'uz', 'pam', 'lmo',
            'yi', 'hy', 'mi', 'zh-min-nan', 'nah', 'glk', 'hsb', 'co', 'kk', 'sah',
            'als', 'li', 'roa-rup', 'ia', 'tt', 'yo', 'bcl', 'os', 'gan', 'arz',
            'fiu-vro', 'nds-nl', 'tk', 'vls', 'mn', 'sa', 'fo', 'am', 'nrm', 'dv',
            'pag', 'rm', 'map-bms', 'wuu', 'gv', 'bar', 'ne', 'my', 'sco', 'se',
            'diq', 'fur', 'pnb', 'lij', 'nov', 'si', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'pi', 'zh-classical', 'lad', 'km', 'ug', 'sc', 'frp', 'mg', 'ang',
            'kw', 'pdc', 'haw', 'szl', 'ps', 'hif', 'kv', 'pa', 'ie', 'to',
            'hak', 'bo', 'myv', 'crh', 'gn', 'ln', 'stq', 'nv', 'jbo', 'arc',
            'mhr', 'ext', 'wo', 'ace', 'ky', 'tpi', 'ty', 'cbk-zam', 'so', 'eml',
            'zea', 'srn', 'ckb', 'ay', 'pap', 'ig', 'kab', 'kg', 'or', 'ba',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ce', 'sm', 'av', 'ks',
            'xal', 'tet', 'got', 'ab', 'sd', 'mdf', 'na', 'pnt', 'iu', 'bm',
            'kl', 'pih', 'as', 'pcd', 'cdo', 'mwl', 'chr', 'ee', 'om', 'zu',
            'ti', 'ts', 'za', 'ss', 've', 'bi', 'ha', 'cr', 'dz', 'bxr',
            'ch', 'bug', 'xh', 'tn', 'ki', 'ik', 'rw', 'st', 'ny', 'tw',
            'chy', 'ak', 'fj', 'sn', 'ff', 'lg', 'sg', 'lbe', 'rn', 'tum',
            'ng',
        ]
