...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lb', 'bs', 'is', 'mr', 'cy', 'lv', 'jv', 'sq', 'tl', 'war', 'bpy',
            'pms', 'be-x-old', 'ta', 'bn', 'oc', 'an', 'be', 'io', 'sw', 'nds',
            'scn', 'fy', 'qu', 'af', 'su', 'gu', 'zh-yue', 'ast', 'ur', 'nap',
            'ku', 'bat-smg', 'ml', 'wa', 'lmo', 'cv', 'ksh', 'ga', 'tg',
            'roa-tara', 'hy', 'vec', 'kn', 'gd', 'yi', 'uz', 'pam', 'yo',
            'zh-min-nan', 'mi', 'kk', 'sah', 'als', 'nah', 'li', 'tt', 'glk',
            'hsb', 'co', 'roa-rup', 'arz', 'os', 'gan', 'ia', 'bcl', 'mn',
            'fiu-vro', 'nds-nl', 'vls', 'pnb', 'fo', 'tk', 'sa', 'am', 'ne',
            'dv', 'nrm', 'pag', 'rm', 'bar', 'gv', 'map-bms', 'my', 'sco',
            'diq', 'wuu', 'se', 'fur', 'lij', 'si', 'ug', 'nov', 'mt', 'bh',
            'mzn', 'csb', 'ilo', 'zh-classical', 'pi', 'lad', 'km', 'sc', 'mg',
            'frp', 'ang', 'kw', 'hif', 'ckb', 'haw', 'pdc', 'szl', 'bo', 'pa',
            'ps', 'ie', 'hak', 'kv', 'to', 'crh', 'stq', 'myv', 'gn', 'ln',
            'ace', 'mhr', 'nv', 'ky', 'ext', 'cbk-zam', 'arc', 'jbo', 'wo',
            'ty', 'eml', 'tpi', 'kab', 'so', 'xal', 'zea', 'pap', 'srn', 'ay',
            ...
            'bxr', 'lbe', 'rw', 'tw', 'st', 'ny', 'sn', 'ff', 'chy', 'lg',
            'tum', 'rn',
        ]
