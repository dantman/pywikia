...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'hr', 'et', 'new', 'ms', 'war', 'simple', 'th', 'gl', 'nn',
            'eu', 'hi', 'ht', 'el', 'te', 'ceb', 'mk', 'la', 'ka', 'az', 'br',
            'sh', 'lb', 'bs', 'is', 'mr', 'jv', 'lv', 'cy', 'tl', 'sq', 'pms',
            'bpy', 'be-x-old', 'ta', 'oc', 'bn', 'an', 'be', 'io', 'sw', 'fy',
            'nds', 'scn', 'af', 'qu', 'gu', 'su', 'zh-yue', 'lmo', 'ast', 'ur',
            'nap', 'roa-rup', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'tg', 'hy', 'roa-tara', 'vec', 'kn', 'yo', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'mi', 'sah', 'kk', 'tt', 'als', 'nah', 'li',
            'glk', 'hsb', 'arz', 'co', 'gan', 'ia', 'bcl', 'mn', 'pnb',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'tk', 'sa', 'ne', 'am', 'dv',
            'nrm', 'bar', 'pag', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq',
            'wuu', 'se', 'si', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn',
            'csb', 'ilo', 'zh-classical', 'pi', 'lad', 'km', 'mg', 'sc', 'ang',
            'frp', 'kw', 'hif', 'ckb', 'bo', 'pdc', 'haw', 'szl', 'pa', 'hak',
            'ps', 'ie', 'kv', 'crh', 'to', 'stq', 'myv', 'cbk-zam', 'ace', 'gn',
            'ln', 'nv', 'krc', 'mhr', 'ky', 'ext', 'xal', 'jbo', 'arc', 'wo',
            'ty', 'eml', 'kab', 'tpi', 'so', 'pap', 'zea', 'srn', 'ay', 'fj',
            'ba', 'ig', 'or', 'dsb', 'kg', 'udm', 'lo', 'kl', 'rmy', 'cu', 'ce',
            'mwl', 'ab', 'kaa', 'sm', 'av', 'ks', 'tet', 'got', 'pcd', 'sd',
            'mdf', 'na', 'bm', 'pnt', 'iu', 'pih', 'as', 'cdo', 'ee', 'chr',
            'bug', 'om', 'zu', 'bi', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'sg',
            'dz', 'ch', 'cr', 'xh', 'ik', 'ak', 'lbe', 'tn', 'ki', 'bxr', 'rw',
