...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lv', 'bpy', 'tl', 'jv', 'pms', 'be-x-old', 'bn', 'ta', 'oc', 'an',
            'io', 'be', 'sw', 'nds', 'scn', 'su', 'fy', 'af', 'zh-yue', 'nap',
            'ku', 'ast', 'ur', 'bat-smg', 'gu', 'ml', 'qu', 'wa', 'war', 'cv',
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'kn', 'gd', 'uz', 'pam', 'lmo',
            'yi', 'hy', 'mi', 'zh-min-nan', 'nah', 'glk', 'hsb', 'sah', 'kk', 'co',
            'als', 'li', 'roa-rup', 'ia', 'tt', 'yo', 'bcl', 'os', 'gan', 'arz',
            'fiu-vro', 'nds-nl', 'vls', 'tk', 'mn', 'sa', 'fo', 'am', 'nrm', 'dv',
            'pag', 'rm', 'map-bms', 'wuu', 'gv', 'bar', 'ne', 'my', 'sco', 'diq',
            'se', 'fur', 'pnb', 'lij', 'nov', 'si', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'pi', 'zh-classical', 'lad', 'km', 'ug', 'sc', 'frp', 'mg', 'ang',
            'kw', 'haw', 'pdc', 'szl', 'ps', 'hif', 'bo', 'kv', 'pa', 'ie',
            'to', 'hak', 'myv', 'crh', 'gn', 'ln', 'stq', 'nv', 'jbo', 'arc',
            'mhr', 'ext', 'wo', 'ace', 'ky', 'tpi', 'ty', 'cbk-zam', 'so', 'eml',
            'zea', 'ckb', 'srn', 'ay', 'pap', 'kab', 'ig', 'kg', 'or', 'ba',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ce', 'ab', 'sm', 'av',
            'xal', 'ks', 'tet', 'got', 'sd', 'mdf', 'na', 'pnt', 'iu', 'bm',
            'kl', 'pih', 'as', 'pcd', 'cdo', 'mwl', 'chr', 'ee', 'om', 'zu',
            'ti', 'ts', 'za', 'ss', 've', 'bi', 'ha', 'dz', 'bxr', 'cr',
            'ch', 'bug', 'xh', 'tn', 'fj', 'ki', 'ik', 'rw', 'st', 'ny',
            'tw', 'chy', 'ak', 'sn', 'ff', 'lg', 'sg', 'lbe', 'rn', 'tum',
            'ng',
        ]
