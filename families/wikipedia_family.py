...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'nds', 'scn', 'af', 'qu', 'gu', 'su', 'roa-rup', 'zh-yue', 'lmo',
            'ast', 'ur', 'nap', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'tg', 'hy', 'roa-tara', 'vec', 'kn', 'yo', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'mi', 'sah', 'tt', 'kk', 'als', 'nah', 'li',
            'glk', 'hsb', 'arz', 'co', 'gan', 'ia', 'bcl', 'mn', 'pnb',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'tk', 'sa', 'ne', 'am', 'dv',
            'nrm', 'bar', 'pag', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq',
            'si', 'wuu', 'se', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn',
            'csb', 'ilo', 'zh-classical', 'pi', 'km', 'lad', 'mg', 'sc', 'ang',
            'frp', 'kw', 'hif', 'ckb', 'bo', 'hak', 'pdc', 'haw', 'szl', 'pa',
            'ps', 'ie', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn', 'ln',
            'nv', 'krc', 'mhr', 'ky', 'ext', 'xal', 'cbk-zam', 'jbo', 'arc',
            'wo', 'ty', 'eml', 'kab', 'tpi', 'so', 'pap', 'zea', 'srn', 'ay',
            'fj', 'ba', 'ig', 'or', 'dsb', 'kg', 'udm', 'lo', 'kl', 'rmy', 'cu',
            'ce', 'ab', 'mwl', 'kaa', 'sm', 'av', 'ks', 'tet', 'got', 'pcd',
            'mdf', 'sd', 'na', 'bm', 'pnt', 'iu', 'pih', 'cdo', 'as', 'ee',
            'chr', 'bug', 'om', 'zu', 'bi', 'za', 'ti', 'ss', 'ts', 've', 'ha',
            'sg', 'dz', 'ch', 'cr', 'xh', 'ik', 'ak', 'lbe', 'tn', 'ki', 'bxr',
