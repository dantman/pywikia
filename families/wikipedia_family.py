...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'ar', 'id', 'vi', 'vo', 'sk', 'sr', 'lt', 'he', 'bg', 'fa',
            'sl', 'hr', 'et', 'new', 'ms', 'simple', 'th', 'gl', 'nn', 'eu',
            'hi', 'ht', 'el', 'te', 'ceb', 'mk', 'la', 'ka', 'br', 'az', 'war',
            'sh', 'lb', 'bs', 'is', 'mr', 'cy', 'lv', 'jv', 'sq', 'tl', 'pms',
            'bpy', 'be-x-old', 'ta', 'bn', 'oc', 'an', 'be', 'io', 'sw', 'nds',
            'scn', 'fy', 'qu', 'af', 'su', 'gu', 'zh-yue', 'ast', 'ur', 'nap',
            'ku', 'bat-smg', 'ml', 'wa', 'lmo', 'cv', 'ksh', 'ga', 'tg',
            'roa-tara', 'hy', 'vec', 'kn', 'gd', 'yi', 'uz', 'pam', 'yo', 'os',
            'zh-min-nan', 'mi', 'kk', 'sah', 'als', 'nah', 'li', 'tt', 'glk',
            'hsb', 'co', 'arz', 'roa-rup', 'gan', 'ia', 'bcl', 'mn', 'fiu-vro',
            'nds-nl', 'pnb', 'vls', 'fo', 'tk', 'sa', 'am', 'ne', 'dv', 'nrm',
            'pag', 'bar', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq', 'wuu',
            'se', 'fur', 'lij', 'si', 'ug', 'nov', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'zh-classical', 'pi', 'km', 'lad', 'sc', 'mg', 'frp', 'ang',
            'kw', 'hif', 'ckb', 'haw', 'pdc', 'szl', 'bo', 'pa', 'ps', 'ie',
            'hak', 'kv', 'to', 'crh', 'stq', 'myv', 'gn', 'ln', 'ace', 'mhr',
            'nv', 'ky', 'ext', 'cbk-zam', 'arc', 'jbo', 'wo', 'ty', 'eml',
            'tpi', 'kab', 'krc', 'xal', 'so', 'zea', 'pap', 'srn', 'ay', 'ig',
            'ba', 'or', 'dsb', 'kg', 'lo', 'udm', 'rmy', 'kl', 'cu', 'kaa',
            'ab', 'mwl', 'ce', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'pcd',
            'mdf', 'na', 'bm', 'pnt', 'iu', 'pih', 'as', 'cdo', 'chr', 'bug',
            'ee', 'om', 'zu', 'fj', 'ti', 'za', 'ts', 'ss', 've', 'bi', 'ha',
            'dz', 'ch', 'cr', 'xh', 'ak', 'sg', 'tn', 'ki', 'ik', 'bxr', 'lbe',
            'rw', 'tw', 'st', 'ny', 'sn', 'chy', 'ff', 'lg', 'tum', 'rn',
        ]
