...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'io', 'be', 'sw', 'nds', 'scn', 'su', 'fy', 'qu', 'af', 'zh-yue',
            'nap', 'ku', 'ast', 'ur', 'bat-smg', 'gu', 'ml', 'wa', 'war', 'cv',
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'kn', 'gd', 'uz', 'lmo', 'pam',
            'yi', 'hy', 'mi', 'zh-min-nan', 'nah', 'glk', 'hsb', 'sah', 'li', 'kk',
            'co', 'als', 'roa-rup', 'tt', 'ia', 'yo', 'bcl', 'os', 'gan', 'arz',
            'fiu-vro', 'nds-nl', 'mn', 'vls', 'tk', 'sa', 'fo', 'am', 'nrm', 'dv',
            'pag', 'rm', 'map-bms', 'wuu', 'gv', 'bar', 'ne', 'my', 'sco', 'diq',
            'se', 'fur', 'pnb', 'lij', 'nov', 'si', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'pi', 'zh-classical', 'km', 'lad', 'ug', 'sc', 'frp', 'mg', 'ang',
            'kw', 'haw', 'pdc', 'szl', 'ps', 'hif', 'bo', 'kv', 'ie', 'pa',
            'to', 'ckb', 'hak', 'crh', 'myv', 'gn', 'stq', 'ln', 'nv', 'mhr',
            'jbo', 'arc', 'ext', 'wo', 'ky', 'ace', 'tpi', 'ty', 'cbk-zam', 'so',
            'eml', 'zea', 'srn', 'ay', 'pap', 'kab', 'ig', 'kg', 'ba', 'or',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ab', 'ce', 'sm', 'xal',
            'av', 'ks', 'tet', 'got', 'sd', 'mdf', 'na', 'pnt', 'iu', 'kl',
            'bm', 'pih', 'as', 'pcd', 'cdo', 'mwl', 'om', 'chr', 'ee', 'zu',
