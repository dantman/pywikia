...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'he', 'bg', 'fa', 'sl', 'hr', 'et', 'new', 'ms', 'simple', 'th',
            'gl', 'nn', 'hi', 'ht', 'eu', 'el', 'te', 'ceb', 'mk', 'la',
            'ka', 'br', 'az', 'bs', 'lb', 'sh', 'is', 'mr', 'cy', 'sq',
            'lv', 'jv', 'bpy', 'tl', 'pms', 'be-x-old', 'ta', 'bn', 'oc', 'an',
            'be', 'io', 'sw', 'war', 'nds', 'scn', 'fy', 'qu', 'su', 'af',
            'zh-yue', 'gu', 'ast', 'nap', 'ku', 'ur', 'bat-smg', 'ml', 'wa', 'cv',
            'ksh', 'ga', 'lmo', 'tg', 'roa-tara', 'vec', 'hy', 'kn', 'gd', 'uz',
            'pam', 'yi', 'mi', 'zh-min-nan', 'nah', 'als', 'kk', 'sah', 'glk', 'li',
            'hsb', 'co', 'tt', 'roa-rup', 'yo', 'ia', 'os', 'arz', 'bcl', 'gan',
            'fiu-vro', 'mn', 'nds-nl', 'vls', 'tk', 'fo', 'sa', 'am', 'dv', 'pnb',
            'nrm', 'pag', 'rm', 'ne', 'map-bms', 'bar', 'wuu', 'gv', 'my', 'diq',
            'sco', 'se', 'fur', 'lij', 'si', 'nov', 'mt', 'ug', 'bh', 'mzn',
            'csb', 'ilo', 'zh-classical', 'pi', 'km', 'lad', 'sc', 'frp', 'mg', 'ang',
            'kw', 'pdc', 'haw', 'szl', 'ps', 'ckb', 'hif', 'bo', 'pa', 'ie',
            'hak', 'kv', 'to', 'crh', 'stq', 'myv', 'gn', 'ln', 'mhr', 'nv',
            'ace', 'arc', 'jbo', 'ky', 'ext', 'wo', 'ty', 'tpi', 'eml', 'cbk-zam',
            'so', 'zea', 'kab', 'srn', 'ay', 'pap', 'or', 'ig', 'ba', 'kg',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ab', 'sm', 'ce', 'xal',
            'av', 'ks', 'tet', 'got', 'kl', 'sd', 'mdf', 'na', 'bm', 'pnt',
            'mwl', 'iu', 'pih', 'pcd', 'as', 'cdo', 'chr', 'ee', 'om', 'zu',
            'ti', 'za', 'ts', 'ss', 've', 'bi', 'ha', 'dz', 'ch', 'bxr',
            'cr', 'bug', 'xh', 'tn', 'ki', 'sg', 'ik', 'rw', 'st', 'ak',
            'ny', 'tw', 'chy', 'sn', 'fj', 'ff', 'lg', 'lbe', 'tum', 'rn',
        ]
