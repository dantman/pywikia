...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'be', 'io', 'sw', 'nds', 'scn', 'fy', 'qu', 'su', 'af', 'zh-yue',
            'ast', 'gu', 'nap', 'ku', 'war', 'ur', 'bat-smg', 'ml', 'wa', 'cv',
            'ksh', 'ga', 'lmo', 'tg', 'roa-tara', 'vec', 'kn', 'hy', 'gd', 'uz',
            'pam', 'yi', 'mi', 'zh-min-nan', 'nah', 'kk', 'als', 'sah', 'glk', 'li',
            'hsb', 'co', 'roa-rup', 'tt', 'yo', 'ia', 'os', 'bcl', 'arz', 'gan',
            'fiu-vro', 'mn', 'nds-nl', 'vls', 'tk', 'sa', 'fo', 'am', 'dv', 'nrm',
            'pag', 'pnb', 'rm', 'ne', 'map-bms', 'wuu', 'bar', 'gv', 'my', 'sco',
            ...
            'eml', 'zea', 'srn', 'kab', 'ay', 'pap', 'ig', 'or', 'ba', 'kg',
