...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'lmo', 'kn', 'gd', 'hy', 'uz',
            'pam', 'yi', 'mi', 'zh-min-nan', 'nah', 'glk', 'als', 'kk', 'sah', 'hsb',
            'li', 'co', 'roa-rup', 'tt', 'ia', 'yo', 'os', 'bcl', 'gan', 'arz',
            'fiu-vro', 'mn', 'nds-nl', 'vls', 'tk', 'sa', 'fo', 'am', 'nrm', 'dv',
            'pag', 'rm', 'map-bms', 'pnb', 'ne', 'wuu', 'gv', 'bar', 'my', 'sco',
            'diq', 'se', 'fur', 'lij', 'si', 'nov', 'mt', 'bh', 'mzn', 'ug',
            'csb', 'ilo', 'pi', 'zh-classical', 'km', 'lad', 'sc', 'frp', 'mg', 'ang',
            'kw', 'haw', 'pdc', 'szl', 'ps', 'ckb', 'hif', 'bo', 'pa', 'ie',
            'kv', 'to', 'hak', 'crh', 'myv', 'gn', 'stq', 'ln', 'mhr', 'nv',
            ...
            'bm', 'pih', 'mwl', 'as', 'pcd', 'cdo', 'om', 'chr', 'ee', 'zu',
