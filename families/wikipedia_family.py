...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'br', 'az', 'bs', 'lb', 'sh', 'is', 'mr', 'cy', 'jv',
            'sq', 'lv', 'bpy', 'tl', 'pms', 'be-x-old', 'ta', 'bn', 'oc', 'war',
            'an', 'be', 'io', 'sw', 'nds', 'scn', 'fy', 'qu', 'su', 'af',
            'gu', 'zh-yue', 'ast', 'nap', 'ku', 'ur', 'bat-smg', 'ml', 'wa', 'cv',
            'ksh', 'ga', 'lmo', 'tg', 'roa-tara', 'vec', 'hy', 'kn', 'gd', 'uz',
            'yi', 'pam', 'mi', 'zh-min-nan', 'yo', 'als', 'nah', 'kk', 'sah', 'glk',
            'li', 'hsb', 'co', 'tt', 'roa-rup', 'ia', 'os', 'arz', 'bcl', 'gan',
            'mn', 'fiu-vro', 'nds-nl', 'vls', 'tk', 'fo', 'sa', 'am', 'pnb', 'dv',
            'nrm', 'pag', 'rm', 'ne', 'bar', 'map-bms', 'wuu', 'gv', 'my', 'sco',
            ...
            'ace', 'ext', 'arc', 'ky', 'jbo', 'wo', 'ty', 'tpi', 'eml', 'cbk-zam',
            'so', 'zea', 'kab', 'srn', 'ay', 'pap', 'or', 'ig', 'ba', 'kg',
            'lo', 'udm', 'dsb', 'rmy', 'cu', 'kaa', 'ab', 'ce', 'sm', 'xal',
            'av', 'ks', 'kl', 'tet', 'got', 'sd', 'mdf', 'mwl', 'na', 'bm',
            'pnt', 'iu', 'pcd', 'pih', 'as', 'cdo', 'chr', 'ee', 'om', 'zu',
