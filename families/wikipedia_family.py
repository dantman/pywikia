...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'hr', 'et', 'new', 'ms', 'simple', 'th', 'gl', 'war', 'nn',
            'eu', 'hi', 'ht', 'el', 'te', 'ceb', 'mk', 'la', 'ka', 'az', 'br',
            'sh', 'lb', 'bs', 'is', 'mr', 'jv', 'lv', 'cy', 'tl', 'sq', 'pms',
            'bpy', 'be-x-old', 'ta', 'oc', 'bn', 'an', 'be', 'io', 'sw', 'nds',
            'fy', 'scn', 'af', 'qu', 'gu', 'su', 'zh-yue', 'lmo', 'ast', 'ur',
            'nap', 'ku', 'ml', 'bat-smg', 'roa-rup', 'wa', 'cv', 'ksh', 'ga',
            'tg', 'hy', 'roa-tara', 'vec', 'kn', 'yo', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'mi', 'kk', 'tt', 'sah', 'als', 'nah', 'li',
            'glk', 'hsb', 'arz', 'co', 'gan', 'ia', 'bcl', 'mn', 'fiu-vro',
            'pnb', 'nds-nl', 'vls', 'fo', 'tk', 'sa', 'ne', 'am', 'dv', 'nrm',
            'bar', 'pag', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq', 'wuu',
            'se', 'si', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb',
            'ilo', 'zh-classical', 'pi', 'lad', 'km', 'mg', 'sc', 'ang', 'frp',
            'kw', 'hif', 'ckb', 'bo', 'pdc', 'haw', 'szl', 'pa', 'ps', 'hak',
            'ie', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'cbk-zam', 'gn', 'ln',
            'nv', 'krc', 'mhr', 'ky', 'ext', 'jbo', 'arc', 'xal', 'wo', 'ty',
            'eml', 'kab', 'tpi', 'so', 'pap', 'zea', 'srn', 'ay', 'fj', 'ba',
            'ig', 'or', 'dsb', 'kg', 'udm', 'lo', 'kl', 'rmy', 'cu', 'ce',
            'mwl', 'ab', 'kaa', 'sm', 'av', 'ks', 'tet', 'got', 'pcd', 'sd',
            'mdf', 'na', 'bm', 'pnt', 'iu', 'pih', 'as', 'cdo', 'ee', 'bug',
            'chr', 'om', 'zu', 'bi', 'ti', 'za', 'ss', 'ts', 've', 'ha', 'sg',
            'dz', 'ch', 'cr', 'xh', 'ak', 'lbe', 'tn', 'ki', 'ik', 'bxr', 'rw',
            'st', 'tw', 'ny', 'sn', 'chy', 'ff', 'lg', 'tum', 'rn',
        ]
