...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'io', 'an', 'nds', 'scn', 'sw', 'su', 'fy', 'af', 'nap', 'ku',
            'zh-yue', 'ast', 'bat-smg', 'ur', 'gu', 'ml', 'wa', 'qu', 'war', 'cv',
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'gd', 'kn', 'uz', 'pam', 'lmo',
            'yi', 'mi', 'zh-min-nan', 'nah', 'glk', 'hsb', 'hy', 'co', 'kk', 'als',
            'roa-rup', 'sah', 'li', 'ia', 'tt', 'bcl', 'gan', 'os', 'arz', 'nds-nl',
            'fiu-vro', 'tk', 'vls', 'sa', 'fo', 'mn', 'am', 'nrm', 'dv', 'pag',
            'rm', 'map-bms', 'wuu', 'gv', 'ne', 'yo', 'bar', 'my', 'sco', 'se',
            'diq', 'fur', 'pnb', 'lij', 'nov', 'si', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'pi', 'zh-classical', 'km', 'lad', 'ug', 'frp', 'sc', 'ang', 'mg',
            'kw', 'haw', 'pdc', 'ps', 'szl', 'kv', 'pa', 'to', 'hak', 'ie',
            'hif', 'bo', 'myv', 'gn', 'crh', 'ln', 'stq', 'nv', 'arc', 'jbo',
            'wo', 'ace', 'ext', 'mhr', 'ky', 'tpi', 'ty', 'cbk-zam', 'so', 'eml',
            'zea', 'srn', 'ay', 'pap', 'ckb', 'ig', 'kab', 'kg', 'or', 'lo',
            'ba', 'udm', 'dsb', 'rmy', 'kaa', 'ce', 'cu', 'sm', 'ks', 'av',
            'tet', 'got', 'xal', 'sd', 'ab', 'mdf', 'na', 'pnt', 'iu', 'bm',
            'kl', 'pih', 'as', 'cdo', 'mwl', 'chr', 'ee', 'om', 'zu', 'ti',
            'ts', 'za', 'ss', 've', 'bi', 'ha', 'cr', 'dz', 'bxr', 'ch',
            'bug', 'xh', 'tn', 'ki', 'st', 'ik', 'rw', 'ny', 'tw', 'ak',
            'chy', 'fj', 'sn', 'ff', 'lg', 'lbe', 'rn', 'tum', 'sg', 'ng',
        ]
        ...
        self.namespaces[5] = {
            ...
            'tt': [u'Wikipedia бәхәсе', u'Wikipedia bäxäse'],
        ...
        self.alphabetic_revised = [
            ...
            'pag', 'pnb', 'pap', 'ps', 'km', 'pms', 'nds', 'pl', 'pnt', 'pt',
            'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'ru',
            'sah', 'se', 'sa', 'sg', 'sc', 'sco', 'stq', 'st', 'tn', 'sq',
