...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'nap', 'ast', 'ku', 'ur', 'gu', 'bat-smg', 'ml', 'war', 'wa', 'cv',
            'ksh', 'ga', 'tg', 'roa-tara', 'vec', 'kn', 'gd', 'lmo', 'uz', 'pam',
            ...
            'se', 'fur', 'pnb', 'lij', 'si', 'nov', 'mt', 'bh', 'mzn', 'csb',
            'ilo', 'pi', 'zh-classical', 'km', 'lad', 'ug', 'sc', 'frp', 'mg', 'ang',
            'kw', 'haw', 'pdc', 'szl', 'ps', 'hif', 'bo', 'ckb', 'pa', 'kv',
            ...
            'av', 'ks', 'tet', 'got', 'sd', 'mdf', 'na', 'pnt', 'kl', 'iu',
            'bm', 'pih', 'as', 'pcd', 'mwl', 'cdo', 'om', 'chr', 'ee', 'zu',
