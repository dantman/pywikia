...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'scn', 'af', 'cs', 'th', 'sw', 'fy', 'simple', 'br', 'oc', 'he',
            'hr', 'sl', 'hy', 'sq', 'tt', 'la', 'zh-min-nan', 'da', 'tk', 'wa',
            'ast', 'ur', 'hsb', 'kk', 'ky', 'eo', 'wo', 'ang', 'lv', 'hi',
            'ga', 'gn', 'az', 'ia', 'co', 'ka', 'sk', 'ne', 'csb', 'st',
            'ms', 'eu', 'tl', 'mr', 'cy', 'nds', 'kl', 'sd', 'ug', 'ti',
            'mk', 'my', 'ps', 'an', 'sh', 'bn', 'gu', 'km', 'mg', 'ts',
            'qu', 'bs', 'fo', 'am', 'rw', 'chr', 'su', 'om', 'mn', 'nah',
            'ie', 'yi', 'iu', 'be', 'ss', 'gd', 'tg', 'si', 'nn', 'kw',
            'zu', 'gv', 'mt', 'dv', 'pa', 'tpi', 'sg', 'roa-rup', 'mi', 'uz',
            'jv', 'ik', 'so', 'ha', 'ay', 'sa', 'na', 'jbo', 'tn', 'sm',
