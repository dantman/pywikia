...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'gl', 'bg', 'uk', 'ca', 'vo', 'ml', 'li', 'is', 'fa', 'sr',
            'af', 'cs', 'sw', 'th', 'fy', 'scn', 'simple', 'br', 'oc', 'he',
            'sl', 'hy', 'sq', 'tt', 'hr', 'la', 'zh-min-nan', 'da', 'tk', 'ast',
            'wa', 'ur', 'hsb', 'kk', 'ky', 'wo', 'eo', 'ang', 'hi', 'ga',
            'gn', 'az', 'ia', 'co', 'sk', 'csb', 'ne', 'st', 'ms', 'mr',
            'ka', 'tl', 'nds', 'kl', 'sd', 'ug', 'ti', 'eu', 'mk', 'lv',
            'cy', 'ps', 'an', 'sh', 'my', 'bn', 'gu', 'mg', 'km', 'ts',
            'qu', 'bs', 'fo', 'am', 'rw', 'chr', 'su', 'om', 'mn', 'nah',
            'ie', 'yi', 'be', 'iu', 'gd', 'tg', 'nn', 'si', 'zu', 'pa',
            'dv', 'mt', 'kw', 'gv', 'tpi', 'roa-rup', 'mi', 'sg', 'jv', 'uz',
