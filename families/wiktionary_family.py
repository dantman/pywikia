...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'tl', 'nds', 'kl', 'sd', 'ug', 'ti', 'mk', 'ne', 'cy', 'eu',
            'an', 'my', 'sh', 'gu', 'lv', 'mg', 'km', 'ps', 'bn', 'ts',
            'qu', 'bs', 'fo', 'am', 'rw', 'chr', 'su', 'mn', 'om', 'nah',
            'ie', 'yi', 'be', 'iu', 'gd', 'tg', 'nn', 'zu', 'si', 'pa',
            'dv', 'mt', 'kw', 'gv', 'tpi', 'roa-rup', 'mi', 'jv', 'uz', 'ik',
