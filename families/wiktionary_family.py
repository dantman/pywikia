...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'hsb', 'kk', 'ky', 'eo', 'lv', 'wo', 'ang', 'my', 'mg', 'ka', 'hi',
            'co', 'ga', 'gn', 'az', 'ia', 'eu', 'sk', 'csb', 'ms', 'st', 'tl',
            'mr', 'cy', 'nds', 'kl', 'sd', 'ug', 'be', 'ti', 'mk', 'ps', 'sh',
            'an', 'bn', 'gu', 'km', 'ss', 'ts', 'qu', 'bs', 'fo', 'am', 'rw',
            'chr', 'su', 'om', 'mn', 'nah', 'ie', 'yi', 'iu', 'mt', 'kw', 'gv',
            'gd', 'tg', 'si', 'nn', 'zu', 'dv', 'pa', 'tpi', 'sg', 'jv',
            'roa-rup', 'uz', 'mi', 'ik', 'so', 'ha', 'ay', 'lb', 'sa', 'na',
            'jbo', 'tn', 'sm', 'ks', 'fj', 'ln', 'za', 'dz', 'als',
        ]
