...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'fr', 'en', 'lt', 'tr', 'zh', 'ru', 'vi', 'io', 'pl', 'fi',
            'pt', 'hu', 'no', 'el', 'ta', 'it', 'de', 'sv', 'ko', 'nl',
            'lo', 'kn', 'ja', 'ku', 'ar', 'es', 'ro', 'et', 'ml', 'id',
            'te', 'gl', 'bg', 'uk', 'ca', 'vo', 'li', 'is', 'fa', 'sr',
            'af', 'cs', 'scn', 'th', 'sw', 'fy', 'simple', 'br', 'oc', 'he',
            'sl', 'hy', 'hr', 'sq', 'tt', 'la', 'zh-min-nan', 'da', 'ast', 'tk',
            'wa', 'ur', 'hsb', 'kk', 'ky', 'wo', 'eo', 'ang', 'hi', 'ga',
            'gn', 'az', 'ia', 'co', 'sk', 'ka', 'ne', 'csb', 'st', 'ms',
            'tl', 'mr', 'nds', 'kl', 'lv', 'eu', 'sd', 'ug', 'ti', 'cy',
            'mk', 'ps', 'an', 'sh', 'my', 'bn', 'gu', 'km', 'mg', 'ts',
            'qu', 'bs', 'fo', 'am', 'rw', 'chr', 'su', 'om', 'mn', 'nah',
            'ie', 'yi', 'iu', 'be', 'gd', 'tg', 'si', 'nn', 'zu', 'ss',
            'kw', 'pa', 'dv', 'gv', 'mt', 'tpi', 'sg', 'roa-rup', 'mi', 'jv',
