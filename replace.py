...
fixes = {
    ...
    'flags-de': {
        ...
        'replacements': [
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Aa]rgentina[_ ]flag[_ ](large|300).png',          u'[[Bild:Flag of Argentina.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Dd]enmark[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Denmark.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ote[_ ]d\'ivoire[_ ]flag[_ ]300.png',          u'[[Bild:Flag of Cote d\'Ivoire.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ee]stonia[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Estonia.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]rance[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of France.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ii]ndia[_ ]flag[_ ]large.png',                    u'[[Bild:Flag of India.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ii]ran[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Iran.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ii]reland[_ ]flag[_ ]medium.png',                 u'[[Bild:Flag of Ireland.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ii]srael[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Israel.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ii]taly[_ ]flag[_ ]300.png',                      u'[[Bild:Flag of Italy.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Jj]apan[_ ]flag[_ ]300.png',                      u'[[Bild:Flag of Japan.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Jj]ordan[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Jordan.svg'),

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ambodia[_ ]flag[_ ](medium|large).png',        u'[[Bild:Flag of Cambodia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ameroon[_ ]flag[_ ]medium.png',                u'[[Bild:Flag of Cameroon.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]anada[_ ]flagge[_ ]gross.png',                 u'[[Bild:Flag of Canada.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]anada[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Canada.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ape[_ ]verde[_ ]flag[_ ]medium.png',           u'[[Bild:Flag of Cape Verde.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]azakhstan[_ ]flag[_ ]medium.png',              u'[[Bild:Flag of Kazakhstan.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Qatar.png',                       u'[[Bild:Flag of Qatar.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]enya[_ ]flag[_ ]medium.png',                   u'[[Bild:Flag of Kenya.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]olombia[_ ]flag[_ ]medium.png',                u'[[Bild:Flag of Colombia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]omoren[_ ]flagge[_ ]gross.png',                u'[[Bild:Flag of the Comoros.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ongo[_ ]democratic[_ ]flag[_ ]medium.png',     u'[[Bild:Flag of the Democratic Republic of the Congo.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]ongo[_ ]republic[_ ]flag[_ ]medium.png',       u'[[Bild:Flag of the Republic of the Congo.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]roatia[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Croatia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Cuba.png',                        u'[[Bild:Flag of Cuba.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]uba[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Cuba.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]uwait[_ ]flagge[_ ]gross.png',                 u'[[Bild:Flag of Kuwait.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Kk]uwait[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Kuwait.svg'),

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ll]aos[_ ]flagge[_ ]gross.png',                   u'[[Bild:Flag of Laos.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ll]esotho[_ ]flag[_ ]medium.png',                 u'[[Bild:Flag of Lesotho.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ll]iberia[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Liberia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ll]ibya[_ ]flag[_ ]300.png',                      u'[[Bild:Flag of Libya.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ll]uxembourg[_ ]flag[_ ]300.png',                 u'[[Bild:Flag of Luxembourg.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]alaysia[_ ]flag[_ ]300.png',                   u'[[Bild:Flag of Malaysia.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]ali[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Mali.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]alta[_ ]flag[_ ]medium.png',                   u'[[Bild:Flag of Malta.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]orocco[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Morocco.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]arshall[_ ]islands[_ ]flag[_ ]medium.png',     u'[[Bild:Flag of the Marshall Islands.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Mauritania.png',                  u'[[Bild:Flag of Mauritania.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]auritius[_ ]flag[_ ]medium.png',               u'[[Bild:Flag of Mauritius.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]icronesia[_ ]flag[_ ]300.png',                 u'[[Bild:Flag of Micronesia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]oldova[_ ]flag[_ ]large-02.png',               u'[[Bild:Flag of Moldova.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]ozambique[_ ]flag[_ ]medium.png',              u'[[Bild:Flag of Mozambique.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Mm]yanmar[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Myanmar.svg'),

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Nn]amibia[_ ]flag[_ ]medium.png',                 u'[[Bild:Flag of Namibia.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Nn]ew[_ ]zealand[_ ]flag[_ ]300.png',             u'[[Bild:Flag of New Zealand.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Nn]icaragua[_ ]flag[_ ](medium|300).png',         u'[[Bild:Flag of Nicaragua.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Nn]orway[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Norway.svg'),

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Aa]ustria[_ ]flag[_ ]medium.png',                 u'[[Bild:Flag of Austria.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Oo]man[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Oman.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]anama[_ ]flag[_ ]medium.png',                  u'[[Bild:Flag of Panama.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]araguay[_ ]flag[_ ]300.png',                   u'[[Bild:Flag of Paraguay.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]eru[_ ]flag[_ ](medium|300).png',              u'[[Bild:Flag of Peru.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]hilippines[_ ]flag[_ ]300.png',                u'[[Bild:Flag of the Philippines.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]oland[_ ]flag[_ ]medium.png',                  u'[[Bild:Flag of Poland.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Poland.png',                      u'[[Bild:Flag of Poland.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Pp]ortugal[_ ]flag[_ ](large|300).png',           u'[[Bild:Flag of Portugal.svg'),

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Rr]wanda[_ ]flag[_ ]medium.png',                  u'[[Bild:Flag of Rwanda.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Rr]omania[_ ]flag[_ ](medium|300).png',           u'[[Bild:Flag of Romania.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Rr]ussia[_ ]flag[_ ](medium|300).png',            u'[[Bild:Flag of Russia.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]audi[_ ]arabia[_ ]flag[_ ]300.png',            u'[[Bild:Flag of Saudi Arabia.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Zz]imbabwe[_ ]flag[_ ](medium|300).png',          u'[[Bild:Flag of Zimbabwe.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]t[_ ]vincent[_ ]grenadines[_ ]flag[_ ]medium.png',   u'[[Bild:Flag of Saint Vincent and the Grenadines.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]ri[_ ]lanka[_ ]flag[_ ]medium.png',            u'[[Bild:Flag of Sri Lanka.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]udan[_ ]flag[_ ]medium.png',                   u'[[Bild:Flag of Sudan.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]South[_ ]Korea.png',              u'[[Bild:Flag of South Korea.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]uriname[_ ]flag[_ ]300.png',                   u'[[Bild:Flag of Suriname.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]waziland[_ ]flag[_ ]medium.png',               u'[[Bild:Flag of Swaziland.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]yria[_ ]flag[_ ]300.png',                      u'[[Bild:Flag of Syria.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]anzania[_ ]flag[_ ]300.png',                   u'[[Bild:Flag of Tanzania.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]hailand[_ ]flag[_ ]300.png',                   u'[[Bild:Flag of Thailand.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ee]ast[_ ]timor[_ ]flag[_ ]300.png',              u'[[Bild:Flag of East Timor.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]ogo[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Togo.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Togo.png',                       u'[[Bild:Flag of Togo.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]onga[_ ]flag[_ ]300.png',                      u'[[Bild:Flag of Tonga.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]rinidad[_ ]and[_ ]tobago[_ ]flag[_ ]300.png',  u'[[Bild:Flag of Trinidad and Tobago.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]had[_ ]flag[_ ]300.png',                       u'[[Bild:Flag of Chad.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]zech[_ ]republic[_ ]flag[_ ]300.png',          u'[[Bild:Flag of the Czech Republic.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]unisia[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Tunisia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]urkey[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Turkey.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Turkey.png',                     u'[[Bild:Flag of Turkey.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]urkmenistan[_ ]flag[_ ]300.png',               u'[[Bild:Flag of Turkmenistan.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Tt]uvalu[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Tuvalu.svg'),
            
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]ganda[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Uganda.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]kraine[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Ukraine.svg'),
            ...
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Hh]ungary[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Hungary.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]ruguay[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Uruguay.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]s[_ ]flag[_ ]large.png',                       u'[[Bild:Flag of the United States.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]the[_ ]United[_ ]States.png',     u'[[Bild:Flag of the United States.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]zbekistan[_ ]flag[_ ]300.png',                 u'[[Bild:Flag of Uzbekistan.svg'),
            
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Vv]anuatu[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Vanuatu.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]Vatican[_ ]City.png',             u'[[Bild:Flag of the Vatican.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Vv]enezuela[_ ]flag[_ ]300.png',                  u'[[Bild:Flag of Venezuela.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]ae[_ ]flag[_ ]300.png',                        u'[[Bild:Flag of the United Arab Emirates.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Uu]k[_ ]flag[_ ]300.png',                         u'[[Bild:Flag of the United Kingdom.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lag[_ ]of[_ ]the[_ ]United[_ ]Kingdom.png',    u'[[Bild:Flag of the United Kingdom.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Vv]ietnam[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Vietnam.svg'),
            
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Bb]elarus[_ ]flag[_ ]300.png',                    u'[[Bild:Flag of Belarus.svg'),
            # Westsahara

            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]entral[_ ]african[_ ]republic[_ ]flag[_ ]300.png',   u'[[Bild:Flag of the Central African Republic.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Cc]yprus[_ ]flag[_ ]300.png',                     u'[[Bild:Flag of Cyprus.svg'),

            # Former nations
            
            #(u'\[\[(?:[Bb]ild|[Ii]mage):[Ee]ast[_ ]Germany[_ ]flag.png',                     u'[[Bild:       '),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ss]FRY[_ ]flag[_ ]large.png',                     u'[[Bild:Flag of SFR Yugoslavia.svg'),
            (u'\[\[(?:[Bb]ild|[Ii]mage):[Ff]lagge[_ ]der[_ ]Sowjetunion.png',              u'[[Bild:Flag of the Soviet Union.svg'),
            
            # Non-souvereign countries
