...
dateFormats = {
    'January': { 
            ...
            'cv' :      lambda val: dh_noConv( val, u'Кăрлач, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d januari' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. januar' ),
    ...
    'February': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Нарăс, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d februari' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. februar' ),
    ...
    'March': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Пуш, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d miert' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. mars' ),
    ...
    'April': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Ака, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d april' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. april' ),
    ...
    'May': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Çу, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d mei' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. mai' ),
    ...
    'June': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Çěртме, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d juni' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. juni' ),
    ...
    'July': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Утă, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d juli' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. juli' ),
    ...
    'August': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Çурла, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d augustus' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. august' ),
    ...
    'September': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Авăн, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d september' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. september' ),
    ...
    'October': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Юпа, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d oktober' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. oktober' ),
    ...
    'November': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Чӳк, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d november' ),
...
#uses template  'no' :      lambda val: dh_noConv( val, u'%d. november' ),
    ...
    'December': {
            ...
            'cv' :      lambda val: dh_noConv( val, u'Раштав, %d' ),
            ...
            'li' :      lambda val: dh_noConv( val, u'%d december' ),
