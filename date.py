...
dateFormats = {
    'January': { 
            ...
            'ka' :      lambda v: dh_dayOfMnth( v, u'%d იანვარი' ), # ka only January and December added for now
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. januar' ),
    ...
    'February': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Februar %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. februar' ),
    ...
    'March': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Mart %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. mars' ),
    ...
    'April': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'April %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. april' ),
    ...
    'May': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Maj %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. mai' ),
    ...
    'June': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Jun %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. juni' ),
    ...
    'July': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Jul %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. juli' ),
    ...
    'August': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Avgust %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. august' ),
    ...
    'September': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Septembar %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. september' ),
    ...
    'October': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Oktobar %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. oktober' ),
    ...
    'November': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Novembar %d' ),
...
#uses template  'no' :      lambda v: dh_dayOfMnth( v, u'%d. november' ),
    ...
    'December': {
            ...
            'bs' :      lambda v: dh_dayOfMnth( v, u'Decembar %d' ),
