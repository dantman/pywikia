...
formats = {
    ...
    'Number': {
        ...
        'th' :      lambda v: dh_number( v, u'%d (จำนวน)' ),
    ...
    'DecadeAD': {
        ...
        'hu' :      lambda m: multi( m, [
            (lambda v: dh_decAD( v, u'%d-ás évek' ), lambda p: p == 0),
    ...
    'DecadeBC': {
        ...
        # '19-10 v. Chr.'
        'nl' :      lambda v: dh( v, u'%d-%d v. Chr.', lambda i: (encDec0(i)+9,encDec0(i)), lambda ii: ii[1] ),
    ...
    'CenturyAD': {
        ...
        'br' :      lambda v: dh_centuryAD( v, u'%Rvet kantved' ),
