    ...
    def __init__(self):
        ...
        self.namespaces = {
            ...
            3: {
                ...
                'ace': [u'Marit Ureuëng Nguy', u'Pembicaraan Pengguna',
                        u'Bicara Pengguna'],
                ...
                'lad': [u'Message de Empleador', u'Usuario_Discusión'],
                ...
                'ml': [u'ഉപയോക്താവിന്റെ സംവാദം', u'അംഗങ്ങളുടെ സംവാദം',
                       u'ഉസം'],
                ...
                'nah': [u'Tlatequitiltilīlli tēixnāmiquiliztli',
                        u'Usuario Discusión'],
                ...
                'zh': [u'User talk', u'用户讨论', u'用户对话', u'用戶討論',
                       u'用戶對話'],
            },
            4: {
                '_default': u'Project',
            ...
            7: {
                ...
                'ja': [u'ファイル・トーク', u'ファイル‐ノート', u'画像‐ノート'],
                ...
                'lad': [u'Diskussión de Dossia', u'Archivo Discusión'],
                ...
                'ml': [u'പ്രമാണത്തിന്റെ സംവാദം', u'ചിസം',
                       u'ചിത്രത്തിന്റെ_സംവാദം'],
                ...
                'ro': [u'Discuție Fișier', u'Discuţie Fişier',
                       u'Discutie Fisier', u'Discuţie Fisier',
                       u'Discuţie Imagine'],
                ...
                'zh': [u'File talk', u'Image talk', u'文件讨论', u'图像讨论',
                       u'文件对话', u'图像对话', u'文件討論', u'圖像討論', u'文件對話',
                       u'圖像對話'],
            },
            8: {
            ...
            9: {
                ...
                'lad': [u'Diskussión de MediaWiki', u'MediaWiki Discusión'],
                ...
                'nah': [u'Huiquimedia tēixnāmiquiliztli',
                        u'MediaWiki Discusión'],
                ...
                'tt': [u'МедиаВики бәхәсе', u'Медиа Вики бәхәсе',
                       u'MediaWiki bäxäse'],
                ...
                'zh': [u'MediaWiki talk', u'MediaWiki讨论', u'MediaWiki对话',
                       u'MediaWiki討論', u'MediaWiki對話'],
            },
            10: {
                '_default': u'Template',
            ...
            11: {
                ...
                'lad': [u'Diskussión de Xabblón', u'Plantilla_Discusión'],
                ...
                'nah': [u'Nemachiyōtīlli tēixnāmiquiliztli',
                        u'Plantilla Discusión'],
                ...
                'zh': [u'Template talk', u'模板讨论', u'模板討論', u'模板对话',
                       u'模板對話'],
            },
            12: {
                '_default': u'Help',
            ...
            13: {
                ...
                'lad': [u'Diskussión de Ayudo', u'Ayuda_Discusión'],
                ...
                'nah': [u'Tēpalēhuiliztli tēixnāmiquiliztli',
                        u'Ayuda Discusión'],
                ...
                'za': u'帮助讨论',
                'zea': u'Overleg ulpe',
                'zh': [u'Help talk', u'帮助讨论', u'幫助討論', u'幫助對話',
                       u'帮助对话'],
            },
            14: {
                '_default': u'Category',
            ...
            15: {
                ...
                'km': [u'ការពិភាក្សាអំពីចំនាត់ថ្នាក់ក្រុម',
                       u'ការពិភាក្សាអំពីចំណាត់ថ្នាក់ក្រុម'],
                'kn': u'ವರ್ಗ ಚರ್ಚೆ',
                'ko': u'분류토론',
                ...
                'lad': [u'Diskussión de Kateggoría', u'Categoría_Discusión'],
                ...
                'ml': [u'വർഗ്ഗത്തിന്റെ സംവാദം', u'വിസം',
                       u'വിഭാഗത്തിന്റെ സംവാദം', u'വർഗ്ഗത്തിന്റെ_സംവാദം'],
                ...
                'nah': [u'Neneuhcāyōtl tēixnāmiquiliztli',
                        u'Categoría Discusión'],
                ...
                'wuu': u'分类讨论',
                'xal': [u'Әәшлин туск меткән', 'Янзин_тускар_ухалвр'],
                'yi': u'קאַטעגאָריע רעדן',
                'yo': u'Ọ̀rọ̀ ẹ̀ka',
                'za': u'分类讨论',
                'zea': u'Overleg categorie',
                'zh': [u'Category talk', u'分类讨论', u'分類討論', u'分类对话',
                       u'分類對話'],
            },
        }
