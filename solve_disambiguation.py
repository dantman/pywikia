...
ignore={
    ...
    'en':('Wikipedia:Links to disambiguating pages',
          ...
          'Wikipedia:Undisambiguated_abbreviations/CIA_World_Factbook',
          'Wikipedia:Undisambiguated_abbreviations/Country_codes',
          'Wikipedia:Undisambiguated_abbreviations/Currency_codes',
          'Wikipedia:Undisambiguated_abbreviations/Elements',
          'Wikipedia:Undisambiguated_abbreviations/State_codes',
          'Wikipedia:Undisambiguated_abbreviations/units_of_measurement',
          'Wikipedia:Undisambiguated_abbreviations/file_extensions',
          'List_of_acronyms_and_initialisms'
          ),
